		...
		try {
			...
			if (!resultSet.next()) {
				...
				do {
					...
					System.out.println("ID: " + id + ", Name: " + ename + ", Email: " + email + ", supplier: "
							+ supplier + ",Phone Number: " + phonenumber + ", productName: " + productName
							+ ", address: " + address + ", epassword: " + epassword + ", price: " + price
							+ ", category: " + category);
					System.out.println();
